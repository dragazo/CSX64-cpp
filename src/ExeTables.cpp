...
namespace CSX64
{
	...
	const Computer::VPUBinaryDelegate Computer::_TryProcessVEC_FCMP_lookup[32] =
	{
		&Computer::_TryProcessVEC_FCMP_EQ_OQ,
		&Computer::_TryProcessVEC_FCMP_LT_OS,
		&Computer::_TryProcessVEC_FCMP_LE_OS,
		&Computer::_TryProcessVEC_FCMP_UNORD_Q,
		&Computer::_TryProcessVEC_FCMP_NEQ_UQ,
		&Computer::_TryProcessVEC_FCMP_NLT_US,
		&Computer::_TryProcessVEC_FCMP_NLE_US,
		&Computer::_TryProcessVEC_FCMP_ORD_Q,
		&Computer::_TryProcessVEC_FCMP_EQ_UQ,
		&Computer::_TryProcessVEC_FCMP_NGE_US,
		&Computer::_TryProcessVEC_FCMP_NGT_US,
		&Computer::_TryProcessVEC_FCMP_FALSE_OQ,
		&Computer::_TryProcessVEC_FCMP_NEQ_OQ,
		&Computer::_TryProcessVEC_FCMP_GE_OS,
		&Computer::_TryProcessVEC_FCMP_GT_OS,
		&Computer::_TryProcessVEC_FCMP_TRUE_UQ,
		&Computer::_TryProcessVEC_FCMP_EQ_OS,
		&Computer::_TryProcessVEC_FCMP_LT_OQ,
		&Computer::_TryProcessVEC_FCMP_LE_OQ,
		&Computer::_TryProcessVEC_FCMP_UNORD_S,
		&Computer::_TryProcessVEC_FCMP_NEQ_US,
		&Computer::_TryProcessVEC_FCMP_NLT_UQ,
		&Computer::_TryProcessVEC_FCMP_NLE_UQ,
		&Computer::_TryProcessVEC_FCMP_ORD_S,
		&Computer::_TryProcessVEC_FCMP_EQ_US,
		&Computer::_TryProcessVEC_FCMP_NGE_UQ,
		&Computer::_TryProcessVEC_FCMP_NGT_UQ,
		&Computer::_TryProcessVEC_FCMP_FALSE_OS,
		&Computer::_TryProcessVEC_FCMP_NEQ_OS,
		&Computer::_TryProcessVEC_FCMP_GE_OQ,
		&Computer::_TryProcessVEC_FCMP_GT_OQ,
		&Computer::_TryProcessVEC_FCMP_TRUE_US,
	};
}
