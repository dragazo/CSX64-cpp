...
namespace CSX64
{
	...
	inline bool asm_router_SEGMENT(AssembleArgs &args) { return args.TryProcessSegment(); }

	inline bool asm_router_INCBIN(AssembleArgs &args) { return args.TryProcessINCBIN(); }
